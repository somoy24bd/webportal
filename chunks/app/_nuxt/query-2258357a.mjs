...
import { m as asyncDataDefaults, l as useNuxtApp, c as createError, k as useRuntimeConfig } from '../server.mjs';
import { y as withLeadingSlash, j as joinURL, q as withoutTrailingSlash, z as withBase, x as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-b1ce6855.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-f9d3223c.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-2258357a.mjs.map
